...
//                   <div
//                     key={day.getTime()}
//                     className={`p-2 rounded-lg border text-center min-h-16 ${
...
//                 <div key={holiday.id} className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
...
//                 Are you sure you want to delete the holiday "{selectedHoliday.name}" on {formatDisplayDate(selectedHoliday.date)}?
//               </p>
